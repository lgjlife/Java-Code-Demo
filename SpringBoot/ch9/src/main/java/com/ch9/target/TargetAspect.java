...
public class TargetAspect {
    ...
    */
     ...
     /*
       target 按类型匹配，仅接受类名入参，使用+或者不使用没有区别

      target(com.ch9.target.advice.TargetAdvice) : 匹配类或者子类为TargetAdvice的所有方法
   ...
   // @Pointcut(value="execution(* *func3(..))")
    @Pointcut(value="target(com.ch9.target.advice.TargetAdvice)")
