...
*/
@Service
public class TransServiceRequiredB {
    ...
    @Transactional
    public void funcNoExcetion(){

        User user = new User();
        String name = "name:"+new Random().nextInt(10000);
        user.setName(name);
        System.out.println("Service Ｂ　插入 "+ name);

        userMapper.insert(user);
    }

    @Transactional
    public void funcExcetion(boolean enableException){
        ...
        if(enableException){
            System.out.println("TransServiceRequiredB　抛出异常");
