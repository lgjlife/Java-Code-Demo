package com.cloud.frame.security.resource.aop.syslog.aspect;


import com.cloud.frame.security.resource.aop.syslog.anno.PrintUrlAnno;
...
//	@Pointcut(value = "execution(* com.lanmei.*.controller..*(..))")
	@Pointcut(value = "@annotation(com.cloud.frame.security.resource.aop.syslog.anno.PrintUrlAnno)")
